...
def member_produce():
    ...
    try:
        ...
        producer.produce(topicName, member, "歡迎光臨~ again3")
        producer.flush()
        msgCounter += 1
...
if __name__ == '__main__':
    item_consume()
    print("item consume success! next step")
    camera_capture()
    # a = camera_capture()
    print("member recognition success！")
    try:
        member_produce()
        print("member_produce is done！")
    except:
        print("失敗")
